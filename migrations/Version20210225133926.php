 ...
 */
final class Version20210225133926 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, content TEXT NOT NULL, index_number NUMERIC(10, 0) DEFAULT NULL, PRIMARY KEY(id))');
